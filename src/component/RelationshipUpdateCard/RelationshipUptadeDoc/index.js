                ...
                <div className="col-md-10 col-lg-10">
                    <section id="card">
                        <div className="well">
                            ...
                            <h1>UPDATE DOCUMENT RELATUIONSHIPS </h1>
                            <div>
                                <form className="ml-auto" method="post">
                                    ...
                                    <br />
                                    <label className="ml-5" style={{marginTop: '35px'}}>Description</label>
                                    <input type="text" style={{width: '418px'}} />
                                </form>
                            </div>
                            ...
                            <form method="post">
                                <table className="table">
                                    <thead className="thead-dark">
                                        <tr>
                                            <td><input type="text" style={{width :'50px', float:'right'}} /></td>
