                        ...
                        <div className="well">
                            ...
                            <div>
                                <form className="ml-auto" method="post">
                                    ...
                                    <h2>NOTE: THIS RISK HAS NEVER BEEN DEPLOYED</h2>
                                    <br />
                            ...
                            <div style={{display:'flex', flexWrap: 'wrap'}}>
                                ...
                                <input type="Submit" name="Submit" className="btn btn-md " value="REVIEW RULE" style={{backgroundColor: '#2d3f61', color: '#fff', float:'right' , width:'142px', marginLeft:'12rem'}} />
